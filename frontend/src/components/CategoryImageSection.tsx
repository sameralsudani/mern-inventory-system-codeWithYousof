...
const translations = {
  en: {
    productImageAlt: "Category image",
    uploadImage: "Upload image",
    imageHint: "Accepted formats: jpg, jpeg, png",
  },
  ar: {
    productImageAlt: "صورة الفئة",
    uploadImage: "رفع صورة",
    imageHint: "الصيغ المقبولة: jpg, jpeg, png",
  },
};

const CategoryImageSection = ({ category, language }) => {
  const { control, watch } = useFormContext();
  const [productImg, setProductImg] = useState(category?.imageUrl || "");
